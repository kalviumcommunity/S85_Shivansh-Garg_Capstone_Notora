  ...
  <CardContent className="pt-6 rounded-md">
    <div className="flex flex-col md:flex-row gap-4">
      ...
      <div className="flex-1 relative">
        <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#64748b] dark:text-[#cbd5e1] w-4 h-4" />
        <Input
          placeholder="Search notes..."
          value={searchTerm}
          onChange={(e) => setSearchTerm(e.target.value)}
          className="pl-10 bg-white border-[#5375a2] text-black dark:text-black placeholder-[#64748b] dark:placeholder-black focus:outline-none focus:ring-2 focus:ring-[#85cbe5] focus:border-[#85cbe5] transition"
        />
      </div>

      {/* Subject Filter */}
      <Select value={selectedSubject} onValueChange={setSelectedSubject}>
        <SelectTrigger className="w-full md:w-48 bg-white border border-[#e2e8f0] dark:border-[#334155] text-[#64748b] dark:text-black focus:ring-2 focus:ring-[#85cbe5] focus:border-[#85cbe5] transition">
          <Filter className="w-4 h-4 mr-2 text-[#64748b] dark:text-[#cbd5e1]" />
          <SelectValue placeholder="Subject" />
        </SelectTrigger>
        <SelectContent className="bg-white dark:bg-white border border-[#e2e8f0] dark:border-[#334155] shadow-md">
          {subjects.map((subject) => (
            <SelectItem
              key={subject}
              value={subject}
              className="hover:bg-[#f1f5f9] dark:hover:bg-[#334155] hover:text-black dark:hover:text-white transition-colors cursor-pointer text-[#64748b] dark:text-black"
            >
              {subject}
            </SelectItem>
          ))}
      ...
      <Select value={sortBy} onValueChange={setSortBy}>
        <SelectTrigger className="w-full md:w-48 bg-white dark:bg-white border border-[#e2e8f0] dark:border-[#334155] text-black dark:text-black focus:ring-2 focus:ring-[#85cbe5] focus:border-[#85cbe5] transition">
                    ...
                    >
                        <CardHeader className="pb-3">
                            <div className="space-y-2">
                                ...
                                <CardTitle className="text-xl leading-tight group-hover:text-[#1F8ECD] transition-colors font-semibold">
                                    {note.title}
                                </CardTitle>
